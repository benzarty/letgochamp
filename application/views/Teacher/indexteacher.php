<div class="content-wrapper">
 ...
 <th><?php echo $annonce->place; ?></th>
  <th><?php echo $annonce->date; ?></th>
        ...
        <div class="col-lg-4">
          <div class="card m-b-3 bg-primary">
            <div class="card-body text-white">
              <div class="m-b-3 font-weight-bold">
                <h5 class="text-white">Grades
                </h5>
              </div>
              <div class="m-b-2 f-25">20.5% <i class="ti-bar-chart pull-right f-30"></i> </div>
              <div><i class="f-20 ti-upload text-lime"></i> </div>
            </div>
          </div>
